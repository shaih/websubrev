...
$sqlHostClass = empty($MYSQL_HOST)? 'shown' : 'hidden';
$sqlDBClass = empty($MYSQL_DB)? 'shown' : 'hidden';
$sqlPrefixClass = empty($MYSQL_PREFIX)? 'shown' : 'hidden';
$sqlUserClass = (empty($MYSQL_USR) || empty($MYSQL_PWD))? 'shown' : 'hidden';
$uploadClass = empty($SUBMIT_DIR)? 'shown' : 'hidden';
$adminClass = empty($ADMIN_EMAIL)? 'shown' : 'hidden';
...
<tr class="$sqlHostClass"><td class=rjust><a href="../documentation/chair.html#SQLdb" target="documentation" title="click for more help">MySQL&nbsp;Server:</a></td>
...
<tr class="$sqlDBClass"><td class=rjust><a href="../documentation/chair.html#SQLdb" target="documentation" title="click for more help">MySQL&nbsp;Database&nbsp;Name:</a></td>
  <td><input name="confDB" size=40 type=text value="$MYSQL_DB"> (e.g., FOCS2009)
<br/>
...
<tr class="$sqlPrefixClass"><td class=rjust><a href="../documentation/chair.html#SQLdb" target="documentation" title="click for more help">Table-name&nbsp;prefix:</a></td>
  <td><input name="SQLprefix" size=40 type=text value="$MYSQL_PREFIX" class="required"> (e.g., FOCS2009)
<br/>
...
<tr class="$sqlUserClass"><td class=rjust><a href="../documentation/chair.html#SQLdb" target="documentation" title="click for more help">MySQL&nbsp;User:</a></td>
  <td>Name: <input name="user" size="32" type="text" value="$MYSQL_USR"> &nbsp; &nbsp;
   Password: <input name="pwd" size="32" type="password" value="$MYSQL_PWD"><br/>
...
<tr class="$uploadClass"><td class=rjust><a href="../documentation/chair.html#UploadDir" target="documentation" title="click for more help">UPLOAD&nbsp;Directory:</a></td>
  <td><input name="subDir" size="90" value="$SUBMIT_DIR" type="text"><br/>
...
<tr class="$adminClass"><td class=rjust><a href="../documentation/chair.html#adminEmail" target="documentation" title="click for more help">Administrator&nbsp;Email:</a></td>
  <td><input name="admin" size="90" type="text" class="required" value="$ADMIN_EMAIL"><br/>
