...
print <<<EndMark
      <tr>
	    ...
	    (empty list to forgo categories.)
        </td>
      </tr>
      <tr>
      ...
      <tr>
	    ...
	    <input name="subFlags" type="hidden" value="on">
        </td>
      </tr>
  ...
  print <<<EndMark
     <tr><td style="text-align: right;">
	    Supported Formats:<br />(UNcheck to remove)
            <input type="hidden" name="formats" value="on">
        </td>
        <td>
...
print <<<EndMark
      ...
      <tr>
        <td style="text-align: right;">Add supported formats:</td>
        <td><textarea name="addFormats" rows="3" cols="70"></textarea><br>
	    A semi-colon-separated list of formats "<tt>Name1(ext1,
            MIME1); Name2(ext2, MIME2)...</tt>"
        </td>
      </tr>
